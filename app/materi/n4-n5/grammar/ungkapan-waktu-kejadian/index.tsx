...
export default function etc() {
  ...
  const kategori = [
    ...
    path: "/materi/n4-n5/grammar/ungkapan-waktu-kejadian/ta-koto-ga-aru"
    },
    {
    id: "Te Iru / Te Imasu (Sedang Melakukan)",
    path: "/materi/n4-n5/grammar/ungkapan-waktu-kejadian/te-iru-te-imasu"
    },
    {
    id: "Mada ~Te Imasen (Masih Belum Melakukan)",
    path: "/materi/n4-n5/grammar/ungkapan-waktu-kejadian/mada-te-imasen"
    },
];
